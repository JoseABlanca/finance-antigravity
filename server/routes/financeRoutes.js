...
router.post('/investments/correlation', investmentController.getCorrelationMatrix);
router.post('/investments/walkforward', investmentController.getWalkforwardAnalysis);
router.post('/investments/walkforward-matrix', investmentController.getWalkforwardMatrix);
router.get('/investments/financials/:ticker', investmentController.getFinancials);
router.post('/investments/pairplot-seaborn', investmentController.getSeabornPairplot);
